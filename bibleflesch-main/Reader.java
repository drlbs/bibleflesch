...
public class Reader {
        ...
        throws FileNotFoundException
    {
        ...
        HashMap<Integer, String> DCList = new HashMap<Integer,String>();
        ...
        while(scammer.hasNextLine()){
            ...
            DCList.put(q,scammer.nextLine().trim());
            q++;
        }
        ...
        int notHard = 0;
        for(int i = 0; i < words.size(); i++){
            if(DCList.containsValue(words.get(i).word.toLowerCase())){
              //System.out.println("found index of "+ words.get(i).word+ " " + words.get(i).getWordCount() + " times");
